...
สิ่งนี้จะรันทุกอย่างเพื่อตั้งค่าโครงการและเริ่มบอทด้วยตัวละครเริ่มต้น
...
# โครงการนี้พัฒนาอย่างรวดเร็ว บางครั้งคุณอาจต้องล้างโครงการหากคุณกลับมาที่โครงการ
pnpm clean
```

#### ข้อกำหนดเพิ่มเติม

คุณอาจต้องติดตั้ง Sharp หากคุณเห็นข้อผิดพลาดเมื่อเริ่มต้น ลองติดตั้งด้วยคำสั่งต่อไปนี้:
...
- [GitHub Issues](https://github.com/elizaos/eliza/issues). เหมาะสำหรับ: ข้อบกพร่องที่คุณพบเมื่อใช้ Eliza และข้อเสนอแนะคุณสมบัติ
- [Discord](https://discord.gg/ai16z). เหมาะสำหรับ: แบ่งปันแอปพลิเคชันของคุณและพบปะกับชุมชน
