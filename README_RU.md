...
# Проект быстро развивается, иногда нужно очистить проект, если вы возвращаетесь к нему
pnpm clean
```
...
- [Discord](https://discord.gg/ai16z). Лучше всего для: делиться своими приложениями и общаться с сообществом.
